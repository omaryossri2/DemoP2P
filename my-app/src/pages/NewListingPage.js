...
const NewListingPage = () => {
  ...
  return (
    <div className="NewListingPage">
      ...
      <Link to="/viewListings" className="view-button">
        Click here to view Books available for sale 📚
      </Link>
        ...
        {listingType === "teacherNotes" && (
          <>
            ...
            <div className="MarkingSchemeCheck">
              <label htmlFor="markingSchemeIncluded">
              ...
              <input
                ...
                onChange={() =>
                  setMarkingSchemeIncluded(!markingSchemeIncluded)
                }
              />
            </div>
